...
int main(int argc, char** argv)
{
	if (!(argc==4||argc==5))
    {
        printf("USAGE: ./Frequency <Image_Path> <Cutoff frequency> <ILPF/IHPF/BLPF/BHPF> <optional_n>\n");
        return -1;
    }
	...
	if(!strcmp(argv[3],"ILPF")||!strcmp(argv[3],"BLPF"))
		t = 0;
	else if(!strcmp(argv[3],"IHPF")||!strcmp(argv[3],"BHPF"))
		t = 1;
	else{
		 printf("USAGE: ./Frequency <Image_Path> <Cutoff frequency> <ILPF/IHPF/BLPF/BHPF> <optional_n>\n");
        return -1;
    ...
    Mat new_img;
    if(!strcmp(argv[3],"ILPF")||!strcmp(argv[3],"IHPF"))
   		new_img = IPF_Filter(image);
    else if(!strcmp(argv[3],"BLPF")||!strcmp(argv[3],"BHPF"))
    {
    	new_img = BPF_Filter(image);
    }
    string name = "new_img";
    stringstream ss2;
    ss2<<argv[3];
    name.append(ss1.str()).append("_").append(ss2.str()).append(".jpg");
    imshow("Display img", image);
    imshow("Display new_img", new_img);
